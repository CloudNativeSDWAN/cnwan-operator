...
func NewBaseReconciler(cli client.Client, scheme *runtime.Scheme, broker *sr.Broker, anns []string, currNsPolicy types.ListPolicy, countPodKey string) *BaseReconciler {
	allowedAnnotations := map[string]bool{}
